...
Write-Host "+--------------------------------------------+" -ForegroundColor Cyan
Write-Host ""
Write-Host "Installing TIL v2.0.0" -ForegroundColor Blue
Write-Host ""
...
# Download compiler
Write-Host "Downloading TIL v2.0.0 compiler..." -ForegroundColor Blue
...
# Write version file
"2.0.0" | Out-File -FilePath "$TIL_HOME\version" -Encoding UTF8 -NoNewline
...
try {
    ...
    Write-Host "Version: TIL Compiler v2.0.0" -ForegroundColor Cyan
}
